...
export function MeasureInfoDisclosure({ measure, type, onEdit }: MeasureInfoDisclosureProps) {
    ...
    <div className="px-4 py-3">
      ...
      >
        ...
        <ChevronDown
          size={18}
          className={clsx(
            "shrink-0 text-label-tertiary transition-transform dark:text-label-tertiary-dark",
            open && "rotate-180",
          )}
        />
      </button>
